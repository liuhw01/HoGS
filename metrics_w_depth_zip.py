...
def evaluate(model_paths):
    ...
    # depth_path = "../mnt/data/data_for_paper/360_v2/bonsai/depth_depthAnything"
    # depth_path = "../mnt/data/data_for_paper/tandt_db/tandt/truck/depth_depthAnything"
    # depth_path = "../mnt/data/data_for_paper/tandt_db/db/playroom/depth_depthAnything"
    depth_path = "../mnt/data/data_for_paper/DL3DV_benchmark_indoor/24/gaussian_splat/depth_depthAnything"
        ...
        # try:
            ...
            for method in os.listdir(test_dir):
                ...
                for i in range(len(image_names)):
                    ...
                    depth_map = cv2.resize(cv2.imread(depth_name, cv2.IMREAD_ANYDEPTH),
                                           (renders[i].shape[3], renders[i].shape[2]))
                    # return
